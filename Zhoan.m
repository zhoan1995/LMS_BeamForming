...
Geometry.V1PosEnd=[70,-100+i,1.5]; %end position for vehicle 1(movement in y)
Geometry.V2PosStart=[200,-50,1.5]; %start position for vehicle 2
Geometry.V2PosEnd=[200-i,-50-i,1.5]; %end position for vehicle 2(movement in x)
Geometry.I1Pos=[10,-210,1.5]; %position of first interf
Geometry.I2Pos=[-150,100,1.5]; %position of 2nd interf

%Calculating the DoA, AOA, ZOA for I#1 at start
...
%Calculating the DoA, AOA, ZOA  for V#2 at start
Geometry.DistI2Start=sqrt(sum((Geometry.I2Pos(1,1:2)-Geometry.BSPos(1,1:2)).^2));

Geometry.AOAI2Start=atan2(Geometry.BSPos(1,2)-Geometry.I2Pos(1,2),Geometry.BSPos(1,1)-Geometry.I2Pos(1,1))*180/pi;
Geometry.ZOAI2Start=atan2(Geometry.DistI2Start,Geometry.BSPos(1,3)-Geometry.I2Pos(1,3))*180/pi;
...
%DoA=[AoA ZoA]
Geometry.AOAV1Start=atan2(Geometry.BSPos(1,2)-Geometry.V1PosStart(1,2),Geometry.BSPos(1,1)-Geometry.V1PosStart(1,1))*180/pi;
Geometry.ZOAV1Start=atan2(Geometry.DistV1Start,Geometry.BSPos(1,3)-Geometry.V1PosStart(1,3))*180/pi;
...
%% LMS BF
n_iter=200; % number of iteration for LMS alg

[out_arr_v1 ,w_v1]=LMSBF(Geometry, pars, doas, chOut*1e3, waveform1,n_iter);
[out_arr_v2, w_v2]=LMSBF(Geometry, pars, doas, chOut*1e3, waveform2,n_iter);
